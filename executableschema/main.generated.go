...
type QueryResolver interface {
	User(ctx context.Context, name string) (*dtos.User, error)
}
...
func (ec *executionContext) _Query_user(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOUser2ᚖgithubᚗcomᚋaerealᚋenjoyᚑgqlgenᚋdtosᚐUser(ctx, field.Selections, res)
}
...
func (ec *executionContext) _User_role(ctx context.Context, field graphql.CollectedField, obj *dtos.User) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNRole2githubᚗcomᚋaerealᚋenjoyᚑgqlgenᚋdtosᚐRole(ctx, field.Selections, res)
}
